...
const UpdatePetugasSholatJumat = () => {
    ...
    async function submitHandler(e) {
        e.preventDefault()
        try {
            const res = await fetch('/api/updatepetugasjumat', {
                method: 'PATCH',
                headers: {
        ...
        <>
            ...
            <div className=' mt-5'>
                <div className="jumbotron text-center" style={{ backgroundColor: '#25316D' }}>
                    <h3 className="display-12" style={{ color: 'orange' }}><em>Update Petugas Sholat Jum'at</em></h3>
                </div>
            </div>
...
export default UpdatePetugasSholatJumat;